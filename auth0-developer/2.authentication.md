...
## Configure social login providers or identity providers
* Supported providers:
...
* 4 types
  * Database (Password) (B2C)
    ...
    * Supports Passwordless login via Passkeys
...
## Implement appropriate database action scripts

### Automatic (Progressive) Migration
