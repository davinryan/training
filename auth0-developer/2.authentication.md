...
* (New) OIDC Logout - RP-initiated endpoint (Relaying party - service or application, /oidc/logout or /oidc/logout?federated for 3rd party IdPs also)
  ...
  * Redirect
    * Must be added to Allowed Logout URLs
      * Application settings: If you provide the id_token_hint parameter, or the logout_hint and client_id parameters 
        (you provide these in you actual app call)
...
* Device support
  ...
  * WebAuthN with biometrics - can never be used a second factor. Always progressive enrollment prompt
...
* 4 types
  * Database (Password) (B2C)
    ...
    * Naming: alphanumeric characters plus dashes with max lengh 35 characters
...
* Recommendations
  ...
  * Start with just 1-5 users at firstb
