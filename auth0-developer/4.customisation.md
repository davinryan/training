...
* Its an inversion of control. Normally Auth0 syncs user info. This endpoint allows a remote enterprise identity provider 
...
* Recommendations - whitelist SCIM attributes you want to sync in a SCIM attribute map - whatever the fuck this is??
* What can you sync
  * users
  * roles
  * organisations
