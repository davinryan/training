...
* GOTCHA
  * Auth0 has fucked up ideas about describing tenancy with organisations
    ...
    * **MULTI-TENANCY** to Auth0 is a always referred to as your STUFF being multi-tenanted... fuck!!
    * Its so messed up because it assumes you have to use multiple tenants to achieve multi-tenancy but they don't, 
      they'll just use organisations to achieve multi-tenancy
    * They do support multi-tenancy but they refer to it as **SINGLE TENANCY** ... FUCK!!
...
* VERY IMPORTANT
  * When RBAC is disabled - an application can request any permission defined for the API, scope claim of the access token includes all permissions defined for API
